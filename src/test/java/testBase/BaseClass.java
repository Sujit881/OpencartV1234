...
public Properties p;
	...
	public void setup(String os, String br) throws IOException
	{
		...
		if(p.getProperty("execution_env").equalsIgnoreCase("remote"))
		{
			...
			//check os and browser from xml file
			...
			case "firefoxe": capabilities.setBrowserName("firefox");  break;
	...
	public String captureScreen(String tname) throws IOException 
	{
		...
		//sourceFile.renameTo(targetFile);  //chatgpt improvement by me. if screenshot not work then open it and close below statement.
